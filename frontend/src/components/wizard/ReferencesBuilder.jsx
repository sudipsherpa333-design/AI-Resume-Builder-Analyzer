...
const ReferencesBuilder = ({
    ...
    const getStrengthColor = useCallback((strength) => {
        if (strength >= 9) return 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300';
        if (strength >= 7) return 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300';
        if (strength >= 5) return 'bg-amber-100 text-amber-800 dark:bg-amber-900 dark:text-amber-300';
