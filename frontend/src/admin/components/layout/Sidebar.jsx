...
const Sidebar = ({ isOpen, onClose, isMobile, admin }) => {
    ...
    useEffect(() => {
        ...
        if (path.includes('/admin/dashboard')) setActiveSection('Overview');
        else if (path.includes('/admin/users')) setActiveSection('Content');
        else if (path.includes('/admin/resumes')) setActiveSection('Content');
        else if (path.includes('/admin/templates')) setActiveSection('Content');
        else if (path.includes('/admin/analytics')) setActiveSection('Analytics');
        else if (path.includes('/admin/logs')) setActiveSection('Analytics');
